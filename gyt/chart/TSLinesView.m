...
- (id)init{
    if ((self = [super init])) {
        ...
        lastValueLeftLb.textColor = [UIColor whiteColor];
        ...
        lastValueRightLb.textColor = [UIColor whiteColor];
        ...
        touchValueLeftLb.textColor = [UIColor whiteColor];
        ...
        touchValueRightLb.textColor = [UIColor whiteColor];
        ...
        touchxAxisLb.textColor = [UIColor whiteColor];
...
- (void)layoutLb{
    ...
    for(int i = 0;i< _rAxisLbArr.count; i++){
        UILabel *lable = _rAxisLbArr[i];
        lable.frame = CGRectMake(self.frame.size.width - LBWIDTH + 5, EMPTYHEIGHT + i*baseHeight - LBHEIGHT/2,LBWIDTH -5 ,LBHEIGHT);
    }
...
- (void)touchesBegan:(NSSet<UITouch *> *)touches withEvent:(UIEvent *)event{
    ...
    xDirectrix.frame = CGRectMake(LBWIDTH + i*baseDrawWidth, 0,1, CHARTHEIGHT);
    if (isXDirectrixInCenter) {
        xDirectrix.frame = CGRectMake(LBWIDTH + i*baseDrawWidth + baseDrawWidth/2, 0,1, CHARTHEIGHT);
    }

    yDirectrix.frame = CGRectMake(LBWIDTH , [self yPositionWithyValue:yValuesArr[i]],CHARTWIDTH, 1);
