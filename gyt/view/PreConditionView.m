...
@implementation PreConditionView
{
    int pLastPrice;
    int pDirector;
    int pPrice;
...
-(void)initView
{
    ...
    dirctorLabel.frame = CGRectMake(10, 40, dirctorLabel.contentSize.width, 30);
    ...
    _directorBtn.frame = CGRectMake(dirctorLabel.contentSize.width + 10, 40, 60, 30);
    ...
    _handView.frame = CGRectMake(handLabel.contentSize.width , 80, SCREEN_WIDTH, 30);
    ...
    priceLabel.frame = CGRectMake(10, 120, priceLabel.contentSize.width, 30);
    ...
    _priceBtn.frame = CGRectMake(priceLabel.contentSize.width + 10, 120, 60, 30);
    ...
    _priceView.frame = CGRectMake(10 + 60 + priceLabel.contentSize.width , 120, SCREEN_WIDTH, 30);
